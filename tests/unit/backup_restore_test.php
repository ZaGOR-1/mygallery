...
assert_true(str_contains($restoreScript, "str_contains(\$name, '..')"), 'restore.php must prevent Zip Slip by checking for ..');
assert_true(str_contains($restoreScript, "str_starts_with(\$name, '/')"), 'restore.php must prevent absolute paths');
