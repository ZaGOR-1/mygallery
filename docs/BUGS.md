...
Актуально для MyGallery 6.4.20.
...
Знахідки `FULL_PROJECT_AUDIT.md` рівнів Critical/High/Medium/Low закриті у поточній робочій копії. Історичні знахідки аудиту 2026-06-16 залишені в `docs/AUDIT_FINDINGS_2026-06-16.md` як архівний контекст.
