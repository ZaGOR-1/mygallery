...
Виправлено у v6.4.7: обхід захисту входу від брутфорсу через тривіальну арифметичну CAPTCHA, яка обнуляла часовий локаут (`public/admin/login.php`). Тепер локаут суто час-базований і CAPTCHA його не обходить. Решта знахідок аудиту 2026-06-16 (High/Medium/Low) — у `docs/AUDIT_FINDINGS_2026-06-16.md`, ще не виправлені.
